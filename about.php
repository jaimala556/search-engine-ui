          ...
          <!-- <li id="setting">
            ...
            <ul class="dropdown-content">
              <li><a href="logout.php"><img src="logout.png"></a></li>
               <li><a href="#"><img src="delete.png"></a></li>
            </ul>
          </li> -->
    ...
    <div id="container">
      ...
      <div id="container2">
        ...
        <div class="about_me_1">
          <div class="card">
            <img src="nitin.jpg" alt="Error loading image" />
        ...
        <div class="about_me_1">
          ...
          <div class="card">
            <img src="Anubhav.jpg" alt="Error loading image" />
            ...
            <div class="details">
              ...
              <ul class="social-icons">
                <li>
                  <a href="https://instagram.com/anubhav_2525?igshid=ZDdkNTZiNTM="><i class="fab fa-instagram"></i></a>
                </li>

                <li>
                  <a href="https://github.com/Anubhav2525"><i class="fab fa-github"></i></a>
                </li>

                <li>
                  <a href="https://www.linkedin.com/in/anubhav-ranjan-74238321b"><i class="fab fa-linkedin"></i></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="about_me_1">
          <div class="card">
            <img src="Prajapati.jpg" alt="Error loading image" />
            ...
            <div class="details">
              ...
              <ul class="social-icons">
                <li>
                  <a href="https://www.linkedin.com/in/prajapati-jaimala-2a0b47271?trk=contact-info"><i class="fab fa-linkedin"></i></a>
                </li>
              </ul>
            </div>
          </div>
