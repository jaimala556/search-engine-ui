...
// include 'reset.php';
  if(isset($_REQUEST["submit"]))
  {
    ...
    // verification process with email id  & sotre the values 
    ...
    if(!empty($row))
    {
        ...
        If you have any questions, send us an email infohuntofficial@gmail.com .
  
        Please do not reply back !!";
        $headers = "From: infohuntofficial@gmail.com ";
       
       // $username=$db_field['FirstName'];// store username 
